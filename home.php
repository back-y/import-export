          ...
          <?php
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item active' style='background-image: url(assets/img/slide/main/$slide_image)'>
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item' style='background-image: url(assets/img/slide/main/$slide_image)'>
