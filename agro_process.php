    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li><a class="nav-link scrollto" href="home ">Home</a></li>
          ...
          <li><a class="nav-link scrollto active" href="agro_process ">Agro-Process</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox"> <!-- carousel-inner begin-->
          ...
          <?php
            ...
            $get_slides = "select * from slider_ap LIMIT 0,1";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item active' style='background-image: url(assets/img/slide/agro/$slide_image)'>
              ...
              $get_slides = "select * from slider_ap LIMIT 1,3";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item' style='background-image: url(assets/img/slide/agro/$slide_image)'>
