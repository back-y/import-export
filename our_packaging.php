    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li><a class="nav-link scrollto" href="home ">Home</a></li>
          ...
          <li><a class="nav-link scrollto active" href="our_packaging ">Our Packaging</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox"> <!-- carousel-inner begin-->
          ...
          <?php
            ...
            $get_slides = "select * from our_packaging LIMIT 0,1";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              <div class='carousel-item active' style='background-image: url(assets/img/slide/our_packaging/$slide_image)'>
               
              <div class='carousel-container'>
                <div class='container'>
                  <h2 class='animate__animated text-dark animate__fadeInDown'>Welcome to <span>$title</span></h2>
                  <p class='animate__animated text-dark animate__fadeInUp'></p>
                  <a href='#portfolio' class='btn-get-started animate__animated animate__fadeInUp scrollto'>See More</a>
                </div>
              </div>
            </div>
                  ";
              ...
              $get_slides = "select * from our_packaging LIMIT 1,3";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item' style='background-image: url(assets/img/slide/our_packaging/$slide_image)'>
