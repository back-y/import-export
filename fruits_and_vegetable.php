    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li><a class="nav-link scrollto" href="home ">Home</a></li>
          ...
          <li><a class="nav-link scrollto active " href="fruits_and_vegetable ">Fruits And Vegetable</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox"> <!-- carousel-inner begin-->
          ...
          <?php
            ...
            $get_slides = "select * from slider_fv LIMIT 0,1";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item active' style='background-image: url(assets/img/slide/fv/$slide_image)'>
              ...
              $get_slides = "select * from slider_fv LIMIT 1,3";
            ...
            while($row_slides = mysqli_fetch_array($run_slides)){
              ...
              echo "
                    ...
                    <div class='carousel-item' style='background-image: url(assets/img/slide/fv/$slide_image)'>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row gy-4 portfolio-container">
            ...
            <?php getProFruits_And_Vegetable();?>
